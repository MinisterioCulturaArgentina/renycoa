 ...
 * @version    $Id: ValidFile.php,v 1.1 2009-04-29 06:02:20 root Exp $
 */
...
class dotDev_Validate_ValidFile extends Zend_Validate_Abstract
{
	...
	*/
   	protected $_messageTemplates = array( 
    	self::INI_SIZE => "el archivo supera el tama&ntilde;o m&aacute;ximo permitido",
        self::FORM_SIZE => "el archivo supera el tama&ntilde;o m&aacute;ximo permitido",
        self::PARTIAL => "fall&oacute; las transmisi&oacute;n del archivo",
        self::NO_FILE => "no se indicó un archivo",
        self::NO_TMP_DIR => "error interno",
        self::CANT_WRITE => "error interno",
        self::EXTENSION => "extensi&oacute; no v&aacute;lida",
